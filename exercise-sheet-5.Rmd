...
```{r, echo=FALSE, out.width='40%', fig.align='center', fig.show='hold', fig.cap='**Abbildung 2** - Illustration der hängenden Kette in beiden Variationen'}
knitr::include_graphics(c("figures/sheet-5/p3.png", "figures/sheet-5/p4.png"))
```