...
```{r, echo=FALSE, out.width='49%', fig.align='center', fig.show='hold', fig.cap='Abbildung 1 - Beispiel einer durch Lösung von Problem (2) erhaltenen Rekonstruktion. Links: Verrauschtes Original Y. Rechts: Rekonstruierte Version X mit $\\alpha = 0.5$.'}
